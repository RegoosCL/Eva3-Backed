...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2024 a las 01:41:02
...
(37, 'Can add detalle boleta', 10, 'add_detalleboleta'),
(38, 'Can change detalle boleta', 10, 'change_detalleboleta'),
(39, 'Can delete detalle boleta', 10, 'delete_detalleboleta'),
(40, 'Can view detalle boleta', 10, 'view_detalleboleta'),
...
(3, 'pbkdf2_sha256$260000$Yzs8cJT8KQkRbAOhsl3VSZ$FFBgeStUsLfsPCnYyncamCJpHAOnxshKPOK+jUsoI4c=', '2024-11-15 00:38:32.743650', 1, 'regoadmin', '', '', 'rego@gmail.com', 1, 1, '2024-10-25 01:14:19.408586'),
(7, 'pbkdf2_sha256$260000$RBGu0PkLk8j47NTT69U3si$2wln8yrMsT6YLZN0OMaOn1g11taNRl4/CmdUiwvKkUM=', '2024-11-15 00:29:46.372031', 0, 'RegoosCL', '', '', 'regocl319@gmail.com', 0, 1, '2024-11-12 01:01:58.598097');
...
--
-- Estructura de tabla para la tabla `boletaapp_boleta`
--

CREATE TABLE `boletaapp_boleta` (
  `id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `boletaapp_boleta`
--

INSERT INTO `boletaapp_boleta` (`id`, `fecha_compra`, `subtotal`, `iva`, `total`, `usuario_id`) VALUES
(1, '2024-11-15 00:23:10.489112', 29990.00, 5698.10, 35688.10, 3),
(2, '2024-11-15 00:30:15.277071', 29999.00, 5699.81, 35698.81, 7);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `boletaapp_detalleboleta`
--

CREATE TABLE `boletaapp_detalleboleta` (
  `id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `boletaapp_detalleboleta`
--

INSERT INTO `boletaapp_detalleboleta` (`id`, `cantidad`, `precio_unitario`, `subtotal`, `boleta_id`, `producto_id`) VALUES
(1, 1, 29990.00, 29990.00, 1, 6),
(2, 1, 29999.00, 29999.00, 2, 8);
...
(5, '2024-11-15 00:38:46.096418', '2', 'Boleta #2 - RegoosCL', 2, '[]', 11, 3);
...
(21, 'regoapp', '0003_carrito_contact', '2024-11-15 00:19:22.606238'),
(22, 'boletaapp', '0001_initial', '2024-11-15 00:19:23.038605');
...
('3d215exehgxkxvcr8juah223qtffevu9', '.eJxVjMsOwiAQRf-FtSHDY2h16b7fQAYYpGogKe3K-O_apAvd3nPOfQlP21r81nnxcxIXYcTpdwsUH1x3kO5Ub03GVtdlDnJX5EG7nFri5_Vw_w4K9fKtkbU72zhC0CY4GlNgC4AUDIB1WcfMTEis0LJDBsScEhMoq4YBCMT7A-n1OA4:1t5au8:GmxZFBwslxxsHKDYIFLEv5yVor_Gr2cNxDw1q3C-Tew', '2024-11-12 01:20:16.179232'),
('f3qwok5v5v69ultvpcebnq7vu8p2czzs', 'e30:1tAdrz:yAuy7Z78TGabEjW0O5YE9KIGJb6W3gs9-sYw6xelM44', '2024-11-25 23:30:55.505972'),
('pi0x39cz4fkzn4akbjdrm826dqm331pw', '.eJxVjMsOwiAQRf-FtSHDY2h16b7fQAYYpGogKe3K-O_apAvd3nPOfQlP21r81nnxcxIXYcTpdwsUH1x3kO5Ub03GVtdlDnJX5EG7nFri5_Vw_w4K9fKtkbU72zhC0CY4GlNgC4AUDIB1WcfMTEis0LJDBsScEhMoq4YBCMT7A-n1OA4:1tBkM4:gA7w1FVOZJD_TqFGh9Ys0bex4z6uU8nFosUEuHJwSYI', '2024-11-29 00:38:32.748756');
...
INSERT INTO `regoapp_carrito` (`id`, `nombre_producto`, `cantidad`, `precio`, `total`, `producto_id`) VALUES
(1, 'Chaqueta Trapstar', 1, 29990.00, 29990.00, 6),
(2, 'Sudadera Kenzo Dorada', 1, 29999.00, 29999.00, 8);
...
--
-- Indices de la tabla `boletaapp_boleta`
--
ALTER TABLE `boletaapp_boleta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `boletaapp_boleta_usuario_id_b0f94d1b_fk_auth_user_id` (`usuario_id`);

--
-- Indices de la tabla `boletaapp_detalleboleta`
--
ALTER TABLE `boletaapp_detalleboleta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `boletaapp_detallebol_boleta_id_a251632f_fk_boletaapp` (`boleta_id`),
  ADD KEY `boletaapp_detallebol_producto_id_0ab16f8e_fk_regoapp_p` (`producto_id`);
...
ALTER TABLE `regoapp_carrito`
  ADD PRIMARY KEY (`id`),
  ADD KEY `regoapp_carrito_producto_id_fc9fce3b_fk_regoapp_product_id` (`producto_id`);
...
--
-- AUTO_INCREMENT de la tabla `boletaapp_boleta`
--
ALTER TABLE `boletaapp_boleta`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `boletaapp_detalleboleta`
--
ALTER TABLE `boletaapp_detalleboleta`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Filtros para la tabla `boletaapp_boleta`
--
ALTER TABLE `boletaapp_boleta`
  ADD CONSTRAINT `boletaapp_boleta_usuario_id_b0f94d1b_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`);

--
-- Filtros para la tabla `boletaapp_detalleboleta`
--
ALTER TABLE `boletaapp_detalleboleta`
  ADD CONSTRAINT `boletaapp_detallebol_boleta_id_a251632f_fk_boletaapp` FOREIGN KEY (`boleta_id`) REFERENCES `boletaapp_boleta` (`id`),
  ADD CONSTRAINT `boletaapp_detallebol_producto_id_0ab16f8e_fk_regoapp_p` FOREIGN KEY (`producto_id`) REFERENCES `regoapp_product` (`id`);
...
--
-- Filtros para la tabla `regoapp_carrito`
--
ALTER TABLE `regoapp_carrito`
  ADD CONSTRAINT `regoapp_carrito_producto_id_fc9fce3b_fk_regoapp_product_id` FOREIGN KEY (`producto_id`) REFERENCES `regoapp_product` (`id`);
COMMIT;
